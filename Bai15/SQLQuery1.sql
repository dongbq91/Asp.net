...
Insert into Tintuc(IDLoai, Tieudetin, Noidungtin) values(2,N'Khủng hoảng kinh tế trong năm
2012',N'Tình hình khủng hoảng kinh tế năm 2012 được các chuyên gia kinh tế đánh giá . . .' )
Insert into Tintuc(IDLoai, Tieudetin, Noidungtin) values(1,N'Tranh chấp trên biển đông',N'Trên
các diễn đàn quân sự đang nóng dẫn về tinh hình biển đông . . .')select * from Theloaitin